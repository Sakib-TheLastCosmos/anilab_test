   ...
   return {
      ...
      aboutCont: (obj) => {
         ...
         <footer>
            ...
            <div class="middle">
               <a href="#profile_${obj.adminProfile.uid}">
      ...
      post: (post, window) => {
         ...
         <li class="post" id=${post.id}>
            ...
            <div class="post__right">
               <header>
                  ...
                  <div class="right dropdown_cont">
                     ...
                     <div class="post_options_dropdown dropdown">
                        <ul>
                           <li class="save-anime__btn save-anime__btn-dropdown" data-id=${post.id}>
                              <svg>
               ...
               <main class="view-full-post-btn post_click">
                  <a href="#${window}&post_${post.id}">${post.reviewInfo.reviewShort}<a class="see-more__btn view-full-post-btn" href="#${window}&post_${post.id}">See more...</a></a>
               </main>
               ...
               <footer>
                  <div class="footer_top">
                     ...
                     <div class="author">
                        <div class="author__left">
                           <a href="#profile_${post.authorUID}">
                              <figure class="profile_click">
                        ...
                        <div class="author__right">
                           <a href="#profile_${post.authorUID}">
                              <h4 class="profile_click profile_click_text">${post.author.fullname}</h4>
                           </a>
                  ...
                  <div class="footer__bottom">
                     <div class="left">
                        <button class="save-anime__btn save-anime__btn-main" id=${post.saved? 'saved' : 'not-saved'} data-id=${post.id}>
                           <svg>
      ...
      savedPostItems: (saved, formattedTitle) => {
         ...
         <li class="review" data-id=${saved.id}>
            ...
            <div class="bottom">
               <div class="left">
                  <a href="#profile_${saved.author.uid}">
                     <figure class="profile_click">
               ...
               <div class="right">
                  <a href="#profile_${saved.author.uid}">
                     <h3 class="profile_click profile_click_text">${saved.author.name}</h3>
                  </a>
      ...
      activePanelProfile: profile => {
         return `
         <li>
            <a href="#profile_${profile.uid}">
               <figure class="profile profile_click">
                  <img src=${profile.profilePhoto} alt="">
               </figure>
            </a>
            <p>${profile.name}</p>
      ...
      saveButton: (isSaved, id) => {
         return `
         <button class="save-anime__btn save-anime__btn-main" id=${isSaved? 'saved' : 'not-saved'} data-id=${id}>
            <svg>
      ...
      saveButtonDropdown: (isSaved, id) => {
         return `
            <svg>
               <use href=${isSaved? '../icons/icons.svg#icon__bookmark-remove' : '../icons/icons.svg#icon__bookmark'}></use>
            </svg>

            <a>${isSaved? 'Unsave review' : 'Save review'}</a>
         `
      },
      ...
      notification: (notification) => {
         return `
         <li class="notification post_click_load" data-id=${notification.postID}>
            <figure>
               <img src=${notification.postImg}>
            </figure>
